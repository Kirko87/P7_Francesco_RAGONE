<template>
    <div class="message">
        ...
        <div class="like-button">
            <div class="likes">
                <svg @click="onLike" class="fa-regular like" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <div class="dislikes">
                <svg @click="onDislike" class="fa-regular dislike" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                    <path
