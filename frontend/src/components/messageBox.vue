<template>
    <router-link class="message" :to="{ name: 'main', params: { parent: objectMessage.id } }">
        ...
        <div class="like-button">
           <div class="likes">
            <svg class="fa-regular" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
        ...
        <button class="buttonModify">MODIFY</button>
...
//             const tokenVerify = parseJwtz(tokenUser)
