<template>
    <div class="message">
        ...
        <div class="like-button">
            <div class="likes">
                <svg class="fa-regular" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
...
export default {
    ...
    methods: {
        ...
        async modifyMessages() {
            ...
            const response = await fetch(`http://localhost:3010/Groupomania/message/${this.objectMessage.id}`, {
                method: "PUT",
                headers: {
        ...
        //   showModify() {
        //     this.$refs.my-component-modify.show();
        //   }
